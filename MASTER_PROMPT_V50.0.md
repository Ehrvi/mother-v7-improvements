# MASTER PROMPT V50.0 — MOTHER v81.8 | Ciclo 180 | 2026-03-07
...
## PROTOCOLO DE INICIALIZAÇÃO ANTI-AMNÉSIA V50.0 (MANDATÓRIO)
...
```
Este comando carrega todo o conhecimento acumulado de MOTHER (bd_central). Você DEVE ler e internalizar as entradas retornadas antes de continuar. O BD contém: decisões arquiteturais, NCs corrigidas, resultados de sprints, embasamento científico, e lições aprendidas de 180+ ciclos. **Se o BD retornar vazio, isso é uma NC crítica — investigue antes de continuar.**
...
**R7 — AWAKE incremental:** AWAKE DEVE ser incrementado a cada ciclo (V255 → V256 → V257...). Nunca sobrescreva uma versão anterior — crie uma nova.

**R8 — MASTER PROMPT versionado:** Atualize este arquivo quando o protocolo de inicialização mudar. Versão atual: V50.0.
...
## NÃO-CONFORMIDADES ATIVAS (Ciclo 180)
...
| **V50.0** | **C180** | **Visão definitiva corrigida em TODOS os arquivos. R14 adicionada. NC-VISION-001 encerrada.** |
