...
// NC-ARCH-001 FIX (C185): SHMS v2 + API Gateway + DGM imports moved to top
// Scientific basis: TypeScript module system requires all imports at module level
// Council C185 Delphi+MAD consensus: NC-ARCH-001 CRITICAL — activates 5000 lines SHMS v2
