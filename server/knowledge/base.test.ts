...
describe('Knowledge Acquisition Layer', () => {
  ...
  describe('saveConcept', () => {
    ...
    it('should update existing concept on conflict', async () => {
      ...
      const id1 = await knowledgeBase.saveConcept(conceptName, 'test', description1);
      const id2 = await knowledgeBase.saveConcept(conceptName, 'test', description2);
  ...
  describe('saveLesson', () => {
    ...
    it('should update existing lesson on conflict', async () => {
      ...
      const id1 = await knowledgeBase.saveLesson(lessonTitle, 'test', description1);
      const id2 = await knowledgeBase.saveLesson(lessonTitle, 'test', description2);
  ...
  describe('searchConcepts', () => {
    ...
    it('should filter by concept type', async () => {
      await knowledgeBase.saveConcept('AI Concept', 'ai', 'Artificial intelligence concept');
      await knowledgeBase.saveConcept('DB Concept', 'database', 'Database concept');
    ...
    it('should limit results to topK', async () => {
      ...
      const results = await knowledgeBase.searchConcepts('concept', undefined, 3);
  ...
  describe('searchLessons', () => {
    ...
    it('should filter by lesson type', async () => {
      ...
      await knowledgeBase.saveLesson('Deploy Lesson', 'deployment', 'Deploy carefully');
  ...
  describe('getAllLessons', () => {
    ...
    it('should filter by lesson type', async () => {
      await knowledgeBase.saveLesson('Test Lesson', 'testing', 'Test description');
      await knowledgeBase.saveLesson('Deploy Lesson', 'deployment', 'Deploy description');
  ...
  describe('getStats', () => {
    ...
    it('should calculate average confidence', async () => {
      await knowledgeBase.saveConcept('High Confidence', 'test', 'Description', undefined, 0.9);
      await knowledgeBase.saveConcept('Low Confidence', 'test', 'Description', undefined, 0.7);
