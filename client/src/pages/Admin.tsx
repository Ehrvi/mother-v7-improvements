...
export default function Admin() {
  ...
  const toggleCT = trpc.system.toggleCriticalThinking.useMutation({
    onSuccess: (data) => {
      ...
      toast.success(`Critical Thinking ${data.enabled ? "enabled" : "disabled"}`);
      refetch();
    },
    onError: (error) => {
    ...
    <div className="container max-w-4xl py-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Manage system configuration and feature flags</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enable 8-phase meta-learning process for complex queries (A/B testing)
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {ctEnabled && (
              <div className="rounded-lg bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800 p-4">
                <p className="text-sm text-yellow-900 dark:text-yellow-100">
                  <strong>⚠️ A/B Testing Active:</strong> 10% of queries are using Critical Thinking Central.
                  Monitor metrics to validate 15-25% quality improvement hypothesis.
                </p>
              </div>
            )}
            ...
            <div className="pt-4 border-t">
              ...
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                ...
                <li>Selected queries go through 8-phase meta-learning process</li>
        ...
        <Card className="opacity-50">
          <CardHeader>
            ...
            <CardDescription>
              Additional feature flags and configuration options will appear here
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Future features: SQLite persistence toggle, analytics dashboard settings, knowledge base management
            </p>
          </CardContent>
        </Card>
      </div>
